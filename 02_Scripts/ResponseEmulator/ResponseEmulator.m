classdef ResponseEmulator
    ...
    properties
        ...
        xi = @(v1hr, hs) (v1hr <= 25) .* (-0.1 - 0.65 ./ (1 + 0.15 .* (v1hr - 12).^2) + 0.30 ./ (1 + 0.05 .* (v1hr - 18).^2) + ...
            hs.^(1/3) .* ((-0.011482 -   (-0.1 - 0.65 ./ (1 + 0.15 .* (v1hr - 12).^2) + 0.30 ./ (1 + 0.05 .* (v1hr - 18).^2))) ./ 15^(1/3))) + ...
            (v1hr > 25) .* (-0.22 +  hs.^(1/3) .* (-0.07641 - -0.22) ./ 15.^(1/3))

        mu = @(v1hr, hs, tp) (tp >= sqrt(2 * pi .* hs ./ (9.81 .* 1/9.99))) .* ...
            ((((v1hr <= 25) .* (3.2616e+06  .* v1hr + 7.0845e+07   ./ (1 + 0.041221     * (v1hr - 11.6).^2) - 7.0845e+07 ./ (1 + 0.041221 * (0 - 11.6).^2)) + ... 
            (v1hr > 25 ) .* (3.9 * 10^4  .* v1hr.^2)).^2.0 + ...
            ((1 + (v1hr > 25) * 0.2) .* 1.0636e+07  .* hs.^1.0 .* (1 + (2 + (v1hr > 25) * 2) ./ (1 + 2 .* (tp - 3).^2))).^2.0).^(1/2.0));
                
        sigma = @(v1hr, hs, tp) 0 + (tp >= sqrt(2 * pi .* hs ./ (9.81 .* 1/9.99))) .* ...
            ((((v1hr <= 25) .* (1.148e+05  .* v1hr + 2.2874e+07  ./ (1 + 0.064 * (v1hr - 11.6).^2) +  -1.5975e+07 ./ (1 + 0.2 * (v1hr - 11.6).^2)) + ...
            (v1hr > 25) .* 4700 .* v1hr.^2).^2.0 + ...
            ((1 + (v1hr > 25) * 0.2) .* 1.9019e+06  .* hs.^1.0 .* (1 + (2 + (v1hr > 25) * 2) ./ (1 + 2 .* (tp - 3).^2))).^2.0).^(1/2.0));
