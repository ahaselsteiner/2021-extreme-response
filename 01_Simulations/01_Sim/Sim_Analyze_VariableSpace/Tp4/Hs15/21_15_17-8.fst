------- OpenFAST INPUT FILE -------------------------------------------
Simulation: Tp4	Wind Velocity: 21mps 	Height of referenz velocity: 90m	AnalysisTime: 3630s;	Wave: Significant wave heigth: 15m     Sepctral peak period: 17.8s
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
"../../ElastoDyn/21_ED.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"../../Wind/Tp4/Hs15/21_15_17-8_IW.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
"../../HydroDyn/Tp4/Hs15/21_15_17-8_HD.dat"      HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
