------- OpenFAST INPUT FILE -------------------------------------------
Simulation: Tp2	Wind Velocity: 11mps 	Height of referenz velocity: 90m	AnalysisTime: 3630s;	Wave: Significant wave heigth: 0m            Sepctral peak period: 0s
---------------------- SIMULATION CONTROL --------------------------------------
...
"Wind/Tp2/Hs0/11_0_2_IW.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"AeroDyn15_WD30m.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"ServoDyn_Test_File.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"HydroDyn/0_HD.dat"      HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"2SubDyn_Monopile_WaterDepth30m.dat"      SubFile         - Name of file containing sub-structural input parameters (quoted string)
