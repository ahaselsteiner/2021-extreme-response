------- OpenFAST INPUT FILE -------------------------------------------
Simulation: Wind: Seed 2	Velocity: 35mps 	Height of referenz velocity: 90m	AnalysisTime: 3630s;	Wave: Significant wave height: 10m	Zero upcrossing periode 9s 
---------------------- SIMULATION CONTROL --------------------------------------
...
"../HydroDyn/10_9_Hydro.dat"      HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
