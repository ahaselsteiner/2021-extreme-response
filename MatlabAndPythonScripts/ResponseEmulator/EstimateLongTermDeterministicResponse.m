...
xlim([t(1) t(n)]);
box off
exportgraphics(gcf, 'gfx/ShortResponseTimeLineDeterministic.jpg') 
exportgraphics(gcf, 'gfx/ShortResponseTimeLineDeterministic.pdf') 
...
set(h(2), 'Color', 'k')
set(h(3), 'Color', 'k')
exportgraphics(gcf, 'gfx/LongResponseTimeLineDeterministic.jpg') 
exportgraphics(gcf, 'gfx/LongResponseTimeLineDeterministic.pdf') 
...
figure('Position', [100 100 320 250])
